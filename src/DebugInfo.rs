...
pub const LLVMDWARFSourceLanguageMips_Assembler: std::ffi::c_uint = 59;
pub const LLVMDWARFSourceLanguageGOOGLE_RenderScript: std::ffi::c_uint = 60;
pub const LLVMDWARFSourceLanguageBORLAND_Delphi: std::ffi::c_uint = 61;
